...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICECATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICECATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICECATEGORY actions', async () => {
      const arg = { id: 22395 };
    ...
    it('dispatches UPDATE_SERVICECATEGORY actions', async () => {
      const arg = { id: 22395 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICECATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICECATEGORY actions', async () => {
      const arg = 42666;
