...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CITIZENSERVICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CITIZENSERVICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CITIZENSERVICE actions', async () => {
      const arg = { id: 29387 };
    ...
    it('dispatches UPDATE_CITIZENSERVICE actions', async () => {
      const arg = { id: 29387 };
    ...
    it('dispatches PARTIAL_UPDATE_CITIZENSERVICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CITIZENSERVICE actions', async () => {
      const arg = 42666;
