...
import reducer, {
  ...
  reset,
  updateEntity,
} from './service-form-template.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEFORMTEMPLATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICEFORMTEMPLATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICEFORMTEMPLATE actions', async () => {
      const arg = { id: 24866 };
    ...
    it('dispatches UPDATE_SERVICEFORMTEMPLATE actions', async () => {
      const arg = { id: 24866 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEFORMTEMPLATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICEFORMTEMPLATE actions', async () => {
      const arg = 42666;
