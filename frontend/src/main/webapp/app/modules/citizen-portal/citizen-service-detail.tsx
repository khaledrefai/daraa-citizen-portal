    ...
    <div className="citizen-portal">
      <div className="breadcrumb-bar">
        ...
        <div className="breadcrumb-bar__cta">
          {service.isElectronic && service.serviceLink && (
            <Button tag="a" color="primary" className="me-2" href={service.serviceLink} target="_blank" rel="noopener noreferrer">
              {translate('citizenPortal.actions.applyOnline')}
            </Button>
          )}
        ...
        <Col lg="4">
          <Card className="detail-card highlight">
            <CardBody>
              ...
              {service.isElectronic && service.serviceLink && (
                <div className="mt-3">
                  <p className="detail-label mb-1">{translate('citizenPortal.onlineService.cta')}</p>
                  <Button tag="a" color="primary" href={service.serviceLink} target="_blank" rel="noopener noreferrer" className="w-100">
                    {translate('citizenPortal.actions.applyOnline')}
                  </Button>
                </div>
              )}
