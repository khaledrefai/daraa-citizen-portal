      ...
      <div className="detail-page-header">
        ...
        <div className="d-flex gap-2 align-items-center">
          {service?.isElectronic && service.serviceLink && (
            <Button tag="a" color="primary" href={service.serviceLink} target="_blank" rel="noopener noreferrer">
                ...
                {service.isElectronic && (
                  <Alert color="success" className="mt-3 mb-0">
                    <div className="d-flex flex-column gap-2">
                      <span>هذه الخدمة متاحة إلكترونيًا ويمكن إنجازها بالكامل عبر البوابة.</span>
                      {service.serviceLink && (
                        <Button
                          tag="a"
                          color="success"
