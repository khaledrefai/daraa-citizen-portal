...
import reducer, {
  ...
  reset,
  updateEntity,
} from './required-document.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUIREDDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REQUIREDDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REQUIREDDOCUMENT actions', async () => {
      const arg = { id: 9996 };
    ...
    it('dispatches UPDATE_REQUIREDDOCUMENT actions', async () => {
      const arg = { id: 9996 };
    ...
    it('dispatches PARTIAL_UPDATE_REQUIREDDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REQUIREDDOCUMENT actions', async () => {
      const arg = 42666;
