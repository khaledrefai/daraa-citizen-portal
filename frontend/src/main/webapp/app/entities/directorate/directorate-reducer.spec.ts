...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIRECTORATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DIRECTORATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DIRECTORATE actions', async () => {
      const arg = { id: 9490 };
    ...
    it('dispatches UPDATE_DIRECTORATE actions', async () => {
      const arg = { id: 9490 };
    ...
    it('dispatches PARTIAL_UPDATE_DIRECTORATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DIRECTORATE actions', async () => {
      const arg = 42666;
