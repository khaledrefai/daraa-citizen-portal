...
import gov.daraa.citizen.config.Constants;
import gov.daraa.citizen.domain.User;
import gov.daraa.citizen.repository.UserRepository;
import gov.daraa.citizen.security.AuthoritiesConstants;
...
import gov.daraa.citizen.web.rest.errors.EmailAlreadyUsedException;
import gov.daraa.citizen.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link gov.daraa.citizen.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
